...
const PALETA_BASE_PUBLICO = [
  ...
  { nombre: 'Barbería Premium',     emoji: '✂️', seccion: 'Barberías',         config: { color_primario:'#C8A96B', color_primario_suave:'#C8A96B20', color_fondo:'#111111', color_superficie:'#1E1E1E', color_superficie2:'#181818', color_borde:'#333333', color_texto:'#F5F1EA', color_texto_suave:'#5B5B5B', color_acento:'#C8A96B', color_exito:'#4A7C59', color_peligro:'#EF4444' } },
  // ── Salones & Estética ─────────────────────────────────────────────────
  ...
  { nombre: 'Moda Femenina',        emoji: '👗', seccion: 'Salones & Estética', config: { color_primario:'#0A2342', color_primario_suave:'#0A234218', color_fondo:'#FFFFFF', color_superficie:'#FDF5F5', color_superficie2:'#FAF0F0', color_borde:'#E8D5D5', color_texto:'#0A2342', color_texto_suave:'#6B7280', color_acento:'#F4E9D8', color_exito:'#4A7C59', color_peligro:'#C0392B' } },
  // ── Gastronomía ────────────────────────────────────────────────────────
  { nombre: 'Restaurante Gourmet',  emoji: '🍽️', seccion: 'Gastronomía',       config: { color_primario:'#1F4D3A', color_primario_suave:'#1F4D3A18', color_fondo:'#F7F2E7', color_superficie:'#FFFFFF', color_superficie2:'#F0EAD6', color_borde:'#D9C9B0', color_texto:'#1F4D3A', color_texto_suave:'#4A5759', color_acento:'#C7A15A', color_exito:'#4A7C59', color_peligro:'#C0392B' } },
  // ── Profesionales ──────────────────────────────────────────────────────
  { nombre: 'Abogados',             emoji: '⚖️', seccion: 'Profesionales',     config: { color_primario:'#0A2342', color_primario_suave:'#0A234220', color_fondo:'#FFFFFF', color_superficie:'#F8F9FA', color_superficie2:'#F0F2F5', color_borde:'#D1D5DB', color_texto:'#0A2342', color_texto_suave:'#6B7280', color_acento:'#B8B69E', color_exito:'#4A7C59', color_peligro:'#C0392B' } },
  { nombre: 'Marca Personal',       emoji: '🧑‍💼', seccion: 'Profesionales',     config: { color_primario:'#264653', color_primario_suave:'#26465318', color_fondo:'#FFFFFF', color_superficie:'#FDF8F4', color_superficie2:'#F4E9D8', color_borde:'#E0D5C5', color_texto:'#264653', color_texto_suave:'#6B7280', color_acento:'#E76F51', color_exito:'#4A7C59', color_peligro:'#C0392B' } },
  { nombre: 'Arquitectura',         emoji: '🏛️', seccion: 'Profesionales',     config: { color_primario:'#707070', color_primario_suave:'#70707018', color_fondo:'#FFFFFF', color_superficie:'#F5F1EA', color_superficie2:'#EEEBE5', color_borde:'#D5CFC5', color_texto:'#1E1E1E', color_texto_suave:'#707070', color_acento:'#C8A96B', color_exito:'#4A7C59', color_peligro:'#C0392B' } },
  // ── General ────────────────────────────────────────────────────────────
